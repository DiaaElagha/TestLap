...
namespace TestLap.Areas.Admin.Controllers
{
    ...
    public class BookController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Des,CreatedDate")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Des,CreatedDate")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
